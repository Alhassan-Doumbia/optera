...
function TotalCallCard({ metrics = "blabla" }) {
  ...
  return (
    <>
      ...
      >
        ...
        <div
          id="cardIcon"
          className="w-[50px] h-[50px] flex items-center justify-center bg-positive rounded-xl bg-opacity-20"
        >
          <FiTarget className="text-[25px] text-positive"></FiTarget>
        </div>
      </section>
    </>
  );
